...
class SipMrcpStack {
    ...
    constructor(opts) {
        ...
        // opts.rtp_options: {local_ip, local_ports, preserve_headers, public_ip}
    ...
    create_session(sip_uri, resource_type, offer_payloads, new_session_callback) {
        ...
        const req = {
            ...
            content: mrcp_utils.gen_offer_sdp(
                resource_type,
                this.rtp_options.public_ip || this.rtp_options.local_ip,
                local_rtp_port,
                offer_payloads,
            ),
        }
    ...
    accept(session, payload) {
        ...
        const answer_sdp = mrcp_utils.gen_answer_sdp(
            this.rtp_options.public_ip || this.rtp_options.local_ip,
            this.mrcp_options.local_port,
            session.data.local_rtp_port,
            session.data.sdp_data.connection,
            mrcp_uuid,
            session.data.sdp_data.resource,
            payload,
        )
